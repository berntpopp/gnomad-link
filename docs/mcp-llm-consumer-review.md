...
| 6 | **Extend `dataset` parameter descriptions to name genome builds explicitly** — `"gnomad_r4 (GRCh38, default, largest cohort), gnomad_r3 (GRCh38, whole-genome), gnomad_r2_1 (GRCh37 legacy)"` across all tools using the enum | Schema Clarity | XS (5 lines) |
